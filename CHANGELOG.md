...
### Added
- `PRIVACY.md` — privacy policy documenting data flows to OSV.dev and CISA KEV, required for Claude Code plugin directory submission.
- Privacy section in `README.md` pointing to `PRIVACY.md`.
